...
;; TODO: Increase to u10000000 (10 USDC) in next version to prevent illiquid markets
;; Currently 1 USDC allows too many low-liquidity markets that fail trades due to slippage
;; See: docs/ROADMAP.md Phase 0.5 for market quality improvements
    ...
    (let
      ...
      (let
        ...
        (let
          ...
          (try! (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.usdcx transfer usdc-return tx-sender caller none)))
        ...
        (let
          ...
          (let
            ...
            (let
              ...
              (try! (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.usdcx transfer usdc-out-net (as-contract tx-sender) caller none)))
  ...
  (let
    ...
    (let
      ...
      (let
        ...
        (try! (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.usdcx transfer winning-tokens (as-contract tx-sender) caller none)))
  ...
  (let
    ...
    (let
      ...
      (let
        ...
        (try! (as-contract (contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.usdcx transfer fees-accrued (as-contract tx-sender) caller none)))
